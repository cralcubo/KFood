...
CREATE TYPE saga_status AS ENUM ('STARTED', 'PROCESSING', 'SUCCEEDED', 'COMPENSATING', 'COMPENSATED', 'FAILED');

DROP TYPE IF EXISTS outbox_status;
CREATE TYPE outbox_status AS ENUM ('STARTED', 'COMPLETED', 'FAILED');

-- OUTBOX TABLES TO KEEP TRACK EVENTS SENT TO THE PAYMENT SERVICE --
...
-- OUTBOX TABLES TO KEEP TRACK OF THE EVENTS SENT TO THE RESTAURANT SERVICE --
